...
class TestCase():
    ...
    def verify(self,bundleid,preexpirycommand,Appbuttons,window,timeanddatereset):
...
if __name__ == "__main__":
    ...
    device_status = testcaseobj.verify(constants.Data["bundleid"],constants.Data["postexpirycommand"],buttons,window,constants.Data["timeanddatereset"])
